...
# bdtools
from bdtools.skel import lbl_conn
from bdtools.patch import extract_patches
from bdtools.edt import get_edt
from bdtools.skel import get_skel
...
def preprocess(
    ...
    valid_types = [
        "normal", "edt", "bounds", "interfaces", "centroids", "skeletons"]
...
if __name__ == "__main__":
    ...
    viewer.add_image(np.stack(msks), name="msks", visible=0) 