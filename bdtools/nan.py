...
mask = io.imread(Path('..') / 'tests' / 'resources' / 'nan' / 'mask.tif')
mask_3d = io.imread(Path('..') / 'tests' / 'resources' / 'nan' / 'mask_3d.tif')
noise_nan = io.imread(Path('..') / 'tests' / 'resources' / 'nan' / 'noise_nan.tif')
noise_nan_3d = io.imread(Path('..') / 'tests' / 'resources' / 'nan' / 'noise_nan_3d.tif')
